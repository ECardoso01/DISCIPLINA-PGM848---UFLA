...
print("Questão B - Dimensão, média, máximo, mínimo e variância deste vetor")
#dimensão n° dados e por shape
dim=len(vetor)
...
print("OS Valores maiores que 30 dentro da lista 1 é", vetorma30)
...
print("Questão 1H - Crie uma estrutura de repetição com uso do for (loop) para apresentar na tela cada \n"
